...
if __name__ == '__main__':
    ...
    sim_ = sim_helper( n_sim = 500, heritability_l = [0.5], percent_causal_l = [0.1], beta_var_l = [0.1], image_modality = 'tfmri_list', random_seed = 1, path = '../simulation_result_compare_mcmc', compare_mcmc = True, n_sub_l = [1000], p_sub_l = [50,100,200,500])
    sim_.full_run()