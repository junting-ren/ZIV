...
if __name__ == '__main__':
    if sim_data_indictor:
        sim_ = sim_helper(n_sim = 100, heritability_l = [0.8, 0.5, 0.25],
                          percent_causal_l = [0.1,0.3], 
                          beta_var_l = [0.1], image_modality = None, random_seed = 1, 
                          path = './', compare_mcmc = compare_mcmc, n_sub_l = [1000,2000,4000], 
        ...
        sim_ = sim_helper(n_sim = 100, heritability_l = [0.8, 0.5, 0.25], percent_causal_l = [0.1,0.05, 0.01,0.005], 
